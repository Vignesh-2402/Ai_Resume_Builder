...
def get_api_key(key_name):
    ...
    try:
        ...
        # Secrets file doesn't exist (normal for local dev without secrets.toml)
        return None
    except Exception:
        # Catch-all for any other weird Streamlit access errors
        return None
...
if not GOOGLE_API_KEY:
    st.error("🚨 GOOGLE_API_KEY not found! Please set it in your .env file (local) or Streamlit Secrets (cloud).")
    st.stop()
